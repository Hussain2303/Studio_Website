  ...
  const process = [
    {
      ...
      desc: "We start with a full review of your current social presence, brand voice, and audience. Then we align on goals and expectations.",
    },
    {
      title: "Strategy & Content Planning",
      desc: "We develop a content strategy, design a monthly calendar, and define platforms, tone, and formats tailored to your brand.",
    },
    {
      title: "Execution & Optimization",
      desc: "From content creation to posting, community management, and analytics, we handle it all and continuously refine for performance.",
    },
  ]
      ...
      <div className="relative z-10 px-6 lg:px-20 pt-10 pb-16 space-y-20">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-3xl mx-auto">
            Strategy, consistency, and engagement that keeps your brand thriving online.
          </p>
        </motion.header>
        ...
        <section id="intro" className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <p className="text-white/80 leading-relaxed">
              Your social media presence is more than just content; it&apos;s about strategy, consistency, 
              and real-time connection. At <span className="text-purple-400 font-semibold">Koko Studio</span>, 
              we manage your brand’s social voice across platforms with content that resonates and strategies 
          ...
          >
            <span className="text-white/50">[ Image Placeholder - social-intro.png ]</span>
          </motion.div>
        </section>
        ...
        <section id="how" className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <p className="text-white/80 leading-relaxed">
              We manage your socials with strategy and purpose. From content planning and design to posting, 
              engagement, and analytics, we handle it all to keep your brand active, relevant, and growing.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, scale: 0.9 }}
          ...
          >
            <span className="text-white/50">[ Image Placeholder - social-how.png ]</span>
          </motion.div>
        </section>
        ...
        <section id="expertise" className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {expertise.map((item, i) => (
              ...
              >
                <h3 className="text-lg font-semibold text-purple-400">{item}</h3>
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            className="rounded-2xl overflow-hidden border border-white/10 bg-white/5 h-64 flex items-center justify-center"
          >
            <span className="text-white/50">[ Image Placeholder - social-expertise.png ]</span>
          </motion.div>
        </section>
        ...
        <section id="process" className="max-w-6xl mx-auto">
          ...
          >
            We manage your brand’s online presence with strategy, consistency, and creativity, 
          ...
          <ol className="space-y-6 mb-10">
            {process.map((step, i) => (
              ...
              >
                <div className="mb-2 text-purple-400 font-bold">{`0${i + 1}. ${step.title}`}</div>
          ...
          <motion.div
            ...
            className="rounded-2xl overflow-hidden border border-white/10 bg-white/5 h-64 flex items-center justify-center"
          >
            <span className="text-white/50">[ Image Placeholder - social-process.png ]</span>
          </motion.div>
        </section>
